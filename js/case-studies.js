...
def generate_grounded_executive_insight(kpi_data: dict) -> str:
    ...
    try:
      ...
      keyFindings: "• Validated adherence to source data across all six stress test suites with robust hallucination resistance at temperature 0.2.\n• Designed to reduce repetitive reporting and insight-drafting effort through automated analysis and AI-generated summaries while retaining full analyst oversight.\n• Successfully implemented retry logic with exponential backoff, preventing application crashes during transient API rate limits.",
